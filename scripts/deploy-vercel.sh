...
sync_env_vars() {
  ...
  local VARS="OPENAI_URL OPENAI_API_KEY OPENAI_MODEL APP_TIME_ZONE ARXIV_LIMIT OPENAI_CONCURRENCY MAX_STORED_PAPERS CONDUCTOR_BASE_URL CONDUCTOR_TOKEN CONDUCTOR_DAEMON_HOST CONDUCTOR_WORKSPACE_PATH CONDUCTOR_APP_NAME CONDUCTOR_BACKEND_TYPE CONDUCTOR_SSO_CLIENT_ID CONDUCTOR_SSO_CLIENT_SECRET ARXIV_AUTH_SECRET"
